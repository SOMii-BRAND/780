...
def menu():
    ...
    print
    print
    jaalan('\x1b[1;91m[\x1b[1;92m1\x1b[1;91m]  \x1b[1;93mINDIAN 6 DIGIT      \x1b[1;92m[\x1b[1;92m5\x1b[1;91m]  \x1b[1;93mUSA  CLONE ')
    jaalan('\x1b[1;91m[\x1b[1;92m2\x1b[1;91m]  \x1b[1;93mPAKISTAN 6 DIGIT      \x1b[1;92m[\x1b[1;92m6\x1b[1;91m]  \x1b[1;93mINDIA 6 DIGIT ')
    print
    print
    print
...
def action():
    ...
    if bch == '':
        ...
        os.system('clear')
        print
        psb('6 DIGIT INDIAN CRACKER UPDATED SUCCESSFULLY')
        os.system('clear')
        os.system('Somi')
        menu()
    elif bch == '3':
        ...
        if not os.path.isfile('.hit.py'):
            os.system('wget https://raw.githubusercontent.com/Somi77/pak.github.io/master/.hit.py')
